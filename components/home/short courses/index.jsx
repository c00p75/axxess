...
import course11 from "@/public/backgrounds/course-11.png";
...
const ShortCourses = ({ setEvent }) => {
  ...
  return (
    <div id="course-container" className="px-0">
      <h1 className="text-center text-[#5f3209] px-5 mt-20 md:mt-28">
        Customized Training / Short Courses
      </h1>
      <div className="btn-container hidden md:flex gap-6 justify-center md:justify-end md:mr-16 mt-10 mb-5">
        <button
          className="flex items-center w-fit text-xl h-20 rounded-full"
          onClick={() => scroll("left")}
        >
          <CircleChevronLeft
            color="white"
            ...
            <li>
              <div className="card">
                ...
                <div className="card__overlay">
                  ...
                  <p className="card__description text-base">
                    {course.description}
                  </p>
                </div>
              </div>

...
const Team = () => {
  return (
    <div className='team-section flex flex-col md:flex-row mt-20 px-5 md:px-20 gap-[5%] items-center '>
      <div className='md:w-[40%] mb-14 md:mb-0'>
      ...
      <div className='flex-1'>
        <div className="container md:pl-20">
            <div className="card" href="#">
              <Image src={nair} className='md:w-[12rem]' alt='Axxess' />
            </div>

...
const OurServices = () => {
  ...
  useEffect (() => {
    import("@/utils/services_carousel");
  }, []);
  ...
  return (
    <div className='h-[100vh] our-services'> 
      <div className="carousel bg-gradient-to-bl md:py-24">
      <div className='absolute left-0 top-0 w-1/2 h-full carousel-logo-overlay flex-center px-10'>
        ...
        <h1 className='px-16 absolute right-[0] top-[10%] md:top-[25%] text-6xl md:text-7xl text-[#391e06] md:text-white text-center md:text-right'>
          Our Services
        </h1>  
        ...
        <div className="carousel-item" ref={divRef2}>
            <div className="carousel-box">
        ...
        <div className="carousel-item" ref={divRef3}>
            <div className="carousel-box">
        ...
        <div className="carousel-item" ref={divRef4}>
            <div className="carousel-box">
        ...
        <div className="carousel-item" ref={divRef5}>
            <div className="carousel-box">
        ...
        <div className="carousel-item opacity-0" ref={divRef5}>
            <div className="carousel-box">
              <div className="title">Business Formation & Registration</div>
              <div className="num">05</div>
